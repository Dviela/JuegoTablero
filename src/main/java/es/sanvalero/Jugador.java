...
public class Jugador {
    ...
    //TODO Metodo para generar pociones
    public void colocarPociones(char[][] tablero, char[][] tableroCopia) {
        ...
        tableroCopia[filaPocion][columnaPocion] = pocion; //TODO Copiar pociones a tablero visible
        tableroCopia[filaPocion2][columnaPocion2] = pocion;
    }


        public void copiarPocion ( char[][] tablero){
            tablero[filaPocion][columnaPocion] = pocion;
            tablero[filaPocion2][columnaPocion2] = pocion;
        }
        ...
        public void gestionVidas ( char[][] tablero){
            ...
            } else if (tablero[filaJugador][columnaJugador] == pocion) {  //TODO Al coger una poción sumas una vida
                vidasJugador++;
...
//                jugador.copiarPocion(tableroCopia);
